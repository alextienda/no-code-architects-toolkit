...
Para funcionalidades avanzadas, consulta las guías especializadas:

| Guía | Descripción |
|------|-------------|
| [Multi-Video Projects](./FRONTEND-PROJECTS.md) | Procesamiento batch de múltiples videos |
| [Consolidation](./FRONTEND-CONSOLIDATION.md) | Detección de redundancias entre videos |
| [B-Roll Integration](./FRONTEND-BROLL.md) | Análisis visual de B-Roll con Gemini |
...
- [Multi-Video Projects](./FRONTEND-PROJECTS.md) - Procesamiento batch
- [Consolidation Guide](./FRONTEND-CONSOLIDATION.md) - Detección de redundancias
- [B-Roll Guide](./FRONTEND-BROLL.md) - Análisis visual de B-Roll
